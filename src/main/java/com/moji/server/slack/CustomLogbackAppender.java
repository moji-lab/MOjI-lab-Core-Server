package com.moji.server.slack;

import ch.qos.logback.classic.spi.ILoggingEvent;
import ch.qos.logback.classic.spi.StackTraceElementProxy;
import ch.qos.logback.core.UnsynchronizedAppenderBase;
import ch.qos.logback.core.util.ContextUtil;
import com.moji.server.slack.config.LogConfig;
import com.moji.server.slack.util.JsonUtil;
...
public class CustomLogbackAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
    ...
    public CustomLogbackAppender(final LogConfig logConfig) {
    ...
    private void toSlack(ErrorLog errorLog) {
        ...
        userInformation.setValue(JsonUtil.toPrettyJson(errorLog.getUserInfo()));
        ...
        headerInformation.setValue(JsonUtil.toPrettyJson(errorLog.getHeaderMap()));
        ...
        bodyInformation.setValue(JsonUtil.toPrettyJson(errorLog.getParameterMap()));
        ...
        agentDetail.setValue(JsonUtil.toPrettyJson(errorLog.getAgentDetail()));
