...
public class ResponseMessage {
    ...
    public static final String CREATE_BOARD = "게시물 작성 성공";
    public static final String SHARE_BOARD = "게시물 공유 성공";
    public static final String FAIL_SHARE_BOARD = "게시물 공유 실패";
    public static final String FAIL_CREATE_BOARD = "게시물 작성 실패";
    ...
    public static final String NOT_FOUND_COURSE = "코스가 존재하지 않습니다.";
    ...
    public static final String CREATE_BOARD_COMMENT = "보드 댓글 작성 성공";
    public static final String CREATE_COURSE_COMMENT = "코스 댓글 작성 성공";
    ...
    public static final String SUCCESS_LIKE = "좋아요 성공";
    public static final String SUCCESS_UNLIKE = "좋아요 취소 성공";
